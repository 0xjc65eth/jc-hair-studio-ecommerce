...
const productsWithDiscount = [
  ...
  },
  {
    ...
    seo: {
      slug: 'cadiveu-brasil-cacau-500ml',
      metaTitle: 'Cadiveu Brasil Cacau 500ml',
      metaDescription: 'Progressiva Cadiveu Brasil Cacau 500ml'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'inoar-g-hair-escova-progressiva-alema-kit',
      metaTitle: 'Inoar G-Hair - Kit Escova Progressiva Alemã',
      metaDescription: 'Kit G-Hair com fórmula alemã e queratina'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'sweet-hair-the-first-shampoo-alisante-980ml',
      metaTitle: 'Sweet Hair The First - Shampoo Alisante',
      metaDescription: 'The First Sweet Hair - Primeiro shampoo alisante do mundo'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'forever-liss-botox-capilar-zero-formol-1kg',
      metaTitle: 'Forever Liss Botox Capilar Zero Formol',
      metaDescription: 'Botox capilar Forever Liss sem formol'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'forever-liss-botox-capilar-250g',
      metaTitle: 'Forever Liss Botox Capilar 250g',
      metaDescription: 'Botox capilar Forever Liss 250g'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  ...
  // Maquiagem
  {
    ...
    seo: {
      slug: 'qdb-base-to-no-glow-240f',
      metaTitle: 'QDB Base Tô No Glow 240F',
      metaDescription: 'Base Quem Disse Berenice Tô No Glow'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'ruby-rose-base-fluida-feels-mood',
      metaTitle: 'Ruby Rose Base Feels Mood',
      metaDescription: 'Base Ruby Rose Feels Mood'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  ...
  // Ferramentas
  {
    ...
    seo: {
      slug: 'taiff-secador-tourmaline-ion-2100w',
      metaTitle: 'Taiff Tourmaline Ion 2100W',
      metaDescription: 'Secador Taiff Tourmaline Ion 2100W'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'babyliss-prancha-nano-titanium',
      metaTitle: 'BaByliss Nano Titanium',
      metaDescription: 'Prancha BaByliss Nano Titanium'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  ...
  // Cuidados Diários
  {
    ...
    seo: {
      slug: 'loreal-absolut-repair-gold-quinoa-500ml',
      metaTitle: "L'Oréal Absolut Repair Gold Quinoa",
      metaDescription: 'Shampoo reparador LOréal com Gold Quinoa'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    seo: {
      slug: 'loreal-absolut-repair-gold-quinoa-250ml',
      metaTitle: "L'Oréal Absolut Repair 250ml",
      metaDescription: 'Shampoo Absolut Repair 250ml'
    },
    createdAt: new Date(),
    updatedAt: new Date()
  }
...
async function seedDatabase() {
  ...
  try {
    ...
    try {
      ...
      console.log('⚠️ Não foi possível remover índices (pode não existir)');
    }
