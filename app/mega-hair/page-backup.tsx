...
import Breadcrumbs from '@/components/mega-hair/Breadcrumbs';
import ImageGallery from '@/components/mega-hair/ImageGallery';
import StrandCalculator from '@/components/mega-hair/StrandCalculator';
import ProductComparator from '@/components/mega-hair/ProductComparator';
import ReviewSystem from '@/components/mega-hair/ReviewSystem';
import MegaHairFAQ from '@/components/mega-hair/MegaHairFAQ';
import TestimonialsBeforeAfter from '@/components/mega-hair/TestimonialsBeforeAfter';
import LiveChatSupport from '@/components/mega-hair/LiveChatSupport';
import StockIndicator from '@/components/mega-hair/StockIndicator';

// Dynamic imports for performance
const LazyImageGallery = dynamic(() => import('@/components/mega-hair/ImageGallery'), {
  loading: () => <div className="animate-pulse bg-gray-200 h-64 rounded-lg" />,
  ssr: false
});

const LazyReviewSystem = dynamic(() => import('@/components/mega-hair/ReviewSystem'), {
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              {[
                ...
                { id: 'faq', label: 'FAQ' },
                { id: 'testimonials', label: 'Transformações' }
              ].map((tab) => (
                <button
                  key={tab.id}
