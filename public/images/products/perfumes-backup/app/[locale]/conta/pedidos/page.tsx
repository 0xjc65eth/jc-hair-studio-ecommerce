        ...
        const mockOrders: Order[] = [
          {
            ...
            total: 89.90,
            items: [
              { id: '1', name: 'Shampoo Hidratante L\'Oréal', quantity: 2, price: 24.95, image: '/images/products/shampoos/loreal-hidratante.jpg' },
              { id: '2', name: 'Condicionador Nutritivo', quantity: 1, price: 39.90, image: '/images/products/condicionadores/nutritivo.jpg' }
            ],
            shipping: {
              method: 'Correios PAC',
          ...
          },
          {
            ...
            total: 156.80,
            items: [
              { id: '3', name: 'Kit Progressiva Wella', quantity: 1, price: 156.80, image: '/images/products/progressivas/wella-kit.jpg' }
            ],
            shipping: {
              method: 'Sedex',
              address: 'Rua das Flores, 123 - São Paulo, SP',
          ...
          },
          {
            ...
            total: 67.40,
            items: [
              { id: '4', name: 'Tinta para Cabelo Loreal', quantity: 2, price: 33.70, image: '/images/products/tintas/loreal-tinta.jpg' }
            ],
            shipping: {
              method: 'Correios PAC',
              address: 'Rua das Flores, 123 - São Paulo, SP'
